...
> [!info] О файле
> Нода (`*.node.md`, `NODE/INDEX`): вход в `Assistant.Ai/Nodes/DeviceControl/`. Что здесь лежит и с какой дочерней нодой работать при запросе про ПК, телефон, сервер или умный дом.
