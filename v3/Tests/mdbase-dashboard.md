...
FROM "v3/Tests/mdbase-demo/tasks"
SORT due_date asc
```
...
FROM "v3/Tests/mdbase-demo/people"
SORT full_name asc
```
...
FROM "v3/Tests/mdbase-habits-demo/habits"
...
- `v3/Tests/mdbase-demo/mdbase.yaml`
- `v3/Tests/mdbase-demo/_types/task.md`
- `v3/Tests/mdbase-demo/_types/person.md`
- `v3/Tests/mdbase-demo/queries.md`
- `v3/Tests/mdbase-habits-demo/mdbase.yaml`
- `v3/Tests/mdbase-habits-demo/_types/habit.md`
- `v3/Tests/mdbase-habits-demo/queries.md`
