...
5. [05 Команды](#5-05-команды)
   5.1. [CRUD Node — базовые операции с нодами](#51-crud-node--базовые-операции-с-нодами)
...
*Источник: [.awn-framework.project/00 Index.documentation.md](.awn-framework.project/00 Index.documentation.md) (строки 1-62)*
...
Нода может иметь память.
Суффиксы подсвечивают в системе назначение (роль) файла.
...
Суффикс — это часть в названии папки или файла, которая подсказывает назначение её использования (роль).

---

## 2. 02 Awn-файлы в корне workspace

*Источник: [.awn-framework.project/01 Core/01 Awn-files/Configuration.documentation.md](.awn-framework.project/01 Core/01 Awn-files/Configuration.documentation.md) (строки 1-14)*
...
*Источник: [.awn-framework.project/01 Core/01 Awn-files/Combined.documentation.md](.awn-framework.project/01 Core/01 Awn-files/Combined.documentation.md) (строки 1-9)*
...
*Источник: [.awn-framework.project/01 Core/01 Awn-files/Configuration.documentation.md](.awn-framework.project/01 Core/01 Awn-files/Configuration.documentation.md) (строки 1-9)*
...
*Источник: [.awn-framework.project/01 Core/01 Awn-files/Documentation.documentation.md](.awn-framework.project/01 Core/01 Awn-files/Documentation.documentation.md) (строки 1-10)*
...
*Источник: [.awn-framework.project/02 Components/03 Memories-types/00 Index.documentation.md](.awn-framework.project/02 Components/03 Memories-types/00 Index.documentation.md) (строки 1-1)*
...
### 5.1. CRUD Node — базовые операции с нодами

*Источник: [.awn-framework.project/02 Components/04 Commands-types/01 CRUD Node.documentation.md](.awn-framework.project/02 Components/04 Commands-types/01 CRUD Node.documentation.md) (строки 1-21)*
