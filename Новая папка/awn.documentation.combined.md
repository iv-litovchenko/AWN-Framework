# AWN Documentation Combined

> **Generated:** 2026-05-18  
> **Source:** All `*.documentation.md` files from the vault
...
### 2. Nodes Types
- [2. Ноды типа папка](#2-ноды-типа-папка)
  - [2.1 Workspace](#21-workspace)
  - [2.2 Space](#22-space)
  - [2.3 Cluster](#23-cluster)
  - [2.4 Book](#24-book)
  - [2.5 Collection](#25-collection)
- [3. Ноды типа файл](#3-ноды-типа-файл)
  - [3.1 Part](#31-part)
  - [3.2 Vision](#32-vision)

### 4. Memories Types
- [4. Content/Inner](#4-contentinner)
- [4.1 Content/Outer](#41-contentouter)
- [4.2 Log](#42-log)
- [4.3 Sidecar](#43-sidecar)
- [4.4 Volume](#44-volume)

### 5. Commands
- [5. Команды](#5-команды)
  - [5.1 CRUD Node](#51-crud-node)
...
*Источник: [.awn-framework.project/00 Index.documentation.md](./.awn-framework.project/00%20Index.documentation.md)*
...
*Источник: [.awn-framework.project/02 Components/01 Awn-files/00 Index.documentation.md](./.awn-framework.project/02%20Components/01%20Awn-files/00%20Index.documentation.md)*
...
*Источник: [.awn-framework.project/02 Components/01 Awn-files/Combined.documentation.md](./.awn-framework.project/02%20Components/01%20Awn-files/Combined.documentation.md)*
...
*Источник: [.awn-framework.project/02 Components/01 Awn-files/Configuration.documentation.md](./.awn-framework.project/02%20Components/01%20Awn-files/Configuration.documentation.md)*
...
*Источник: [.awn-framework.project/02 Components/01 Awn-files/Documentation.documentation.md](./.awn-framework.project/02%20Components/01%20Awn-files/Documentation.documentation.md)*
...
*Источник: [.awn-framework.project/02 Components/02 Nodes-types/01 Folders/00 Index.documentation.md](./.awn-framework.project/02%20Components/02%20Nodes-types/01%20Folders/00%20Index.documentation.md)*
...
*Источник: [.awn-framework.project/02 Components/02 Nodes-types/01 Folders/01 Workspace.documentation.md](./.awn-framework.project/02%20Components/02%20Nodes-types/01%20Folders/01%20Workspace.documentation.md)*
...
Файл вида `<name>/Index.node.md` — нода-ориентир папки (область).
Описывает: зачем папка существует, что в ней лежит, какие правила здесь действуют.

*Источник: [.awn-framework.project/02 Components/02 Nodes-types/01 Folders/02 Space.documentation.md](./.awn-framework.project/02%20Components/02%20Nodes-types/01%20Folders/02%20Space.documentation.md)*
...
*Источник: [.awn-framework.project/02 Components/02 Nodes-types/01 Folders/03 Cluster.documentation.md](./.awn-framework.project/02%20Components/02%20Nodes-types/01%20Folders/03%20Cluster.documentation.md)*
...
Файл вида `<name>/Index.node.md` — нода-книга: набор связанных заметок по одной теме.
Описывает, как с этой книгой работать и как добавлять в неё новые записи.
Подходит для базы знаний по определённой тематике.

*Источник: [.awn-framework.project/02 Components/02 Nodes-types/01 Folders/04 Book.documentation.md](./.awn-framework.project/02%20Components/02%20Nodes-types/01%20Folders/04%20Book.documentation.md)*
...
Файл вида `<name>/Index.node.md` — нода-коллекция однотипных данных.
Описывает, как с этой коллекцией работать и как добавлять записи.
Аналог базы данных в папке. Подходит для однотипных данных:
задачи, дневник, история финансов, логи и т.п.

*Источник: [.awn-framework.project/02 Components/02 Nodes-types/01 Folders/05 Collection.documentation.md](./.awn-framework.project/02%20Components/02%20Nodes-types/01%20Folders/05%20Collection.documentation.md)*
...
*Источник: [.awn-framework.project/02 Components/02 Nodes-types/02 Files/01 Part.documentation.md](./.awn-framework.project/02%20Components/02%20Nodes-types/02%20Files/01%20Part.documentation.md)*
...
*Источник: [.awn-framework.project/02 Components/02 Nodes-types/02 Files/zzz 02 Vision.documentation.md](./.awn-framework.project/02%20Components/02%20Nodes-types/02%20Files/zzz%2002%20Vision.documentation.md)*
...
# Content/Inner — внутренняя память ноды
...
*Источник: [.awn-framework.project/02 Components/03 Memories-types/Content/Inner.documentation.md](./.awn-framework.project/02%20Components/03%20Memories-types/Content/Inner.documentation.md)*
...
# Content/Outer — внешняя память ноды

Внешняя память ноды складывается в папку `Content/`.

Базовый шаблон (схема) такой памяти имеет свой набор собственных полей.

*Источник: [.awn-framework.project/02 Components/03 Memories-types/Content/Outer.documentation.md](./.awn-framework.project/02%20Components/03%20Memories-types/Content/Outer.documentation.md)*
...
*Источник: [.awn-framework.project/02 Components/03 Memories-types/Log.documentation.md](./.awn-framework.project/02%20Components/03%20Memories-types/Log.documentation.md)*
...
*Источник: [.awn-framework.project/02 Components/03 Memories-types/Sidecar.documentation.md](./.awn-framework.project/02%20Components/03%20Memories-types/Sidecar.documentation.md)*
...
*Источник: [.awn-framework.project/02 Components/03 Memories-types/Volume.documentation.md](./.awn-framework.project/02%20Components/03%20Memories-types/Volume.documentation.md)*
...
*Источник: [.awn-framework.project/02 Components/04 Commands-types/00 Index.documentation.md](./.awn-framework.project/02%20Components/04%20Commands-types/00%20Index.documentation.md)*
...
*Источник: [.awn-framework.project/02 Components/04 Commands-types/01 CrudNode.documentation.md](./.awn-framework.project/02%20Components/04%20Commands-types/01%20CrudNode.documentation.md)*
...
*Источник: [.awn-framework.project/04 Templates/00 Index.documentation.md](./.awn-framework.project/04%20Templates/00%20Index.documentation.md)*
