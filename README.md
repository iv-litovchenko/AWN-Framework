...
![alt](01_Documentation/assets/Preview.png)

![alt](01_Documentation/assets/fda02247-be70-4e6e-8a89-23944be3dfe6.png)

![Node — атомарные ноды и память агента (инфографика)](01_Documentation/assets/3593354e-2c7d-45c9-859f-8adc1b3f7477.png)

![Permanent Memory: курируемая память (Obsidian), Verbatim-история, Temporal Graph (Graphiti)](01_Documentation/assets/c8ffb2cd-7ae4-4c9d-a038-55a1c6c1bfac.png)

![Дружелюбный ИИ-робот медитирует и организует цифровые папки в саду знаний](01_Documentation/assets/e9cc3257-87c2-42c4-aba2-ed12f0bd7cbd.png)
...
Подробнее это раскрыто в [[01_Documentation/v2/AGENTS#8. Почему не жёсткие «фреймворки» и не чужие конвенции workspace|AGENTS.md -> раздел 8]], где объясняется, почему подход отличается от жёстких фреймворков и OpenClaw-подобных шаблонов.
...
> А 1000 `.memory.md` — это легко **10 000+ страниц**.
...
2. Сравнивает с **векторами всех `.memory.md`** (заранее посчитанными).
...
4. Находит 3 записи:
    - `2026-04-10.memory.md`: _«Боюсь, что это никому не нужно»_
    - `2026-03-22.memory.md`: _«Устал от ощущения, что я опоздал»_
    - `Summary_2025-Q4.memory.md`: _«В конце года часто возникает кризис смысла»_
...
Агент: читает Index → видит список файлов → 
       открывает только Memory/2026/03/*.memory.md
```
...
![AYA — Cognitive Intelligence System (обложка проекта)](01_Documentation/assets/Aya.jpg)
...
![Первые слова агента в Telegram (утро)](01_Documentation/assets/FirstWords.jpg)
