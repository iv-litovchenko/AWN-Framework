...
Моё первое знакомство с агентными системами было невероятным: не инструмент в строке поиска, а ощущение живого напарника, который сам выходит в контакт. Обложка **AYA** — когнитивная система, «второй мозг, который действует» — тогда сложилась с этим чувством в одну картинку. Первое имя цифрового персонажа - Ая (прям как в компьтерных играх — только здесь не игра а реальная жизнь.
