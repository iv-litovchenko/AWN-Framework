...
>
> Попросите своего агента установить данный фреймворк, передав ему инструкцию из файла [`INSTALL.md`](Framework/INSTALL.md).
>
...
- [Установка / обновление (`INSTALL.md`)](Framework/INSTALL.md)
...
- Установка/обновление файлов AWN через агента: [`INSTALL.md`](Framework/INSTALL.md).
