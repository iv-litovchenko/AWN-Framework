...
- [[#Почему здесь нет жёсткой схемы|Почему здесь нет жёсткой схемы]]
...
## Почему здесь нет жёсткой схемы
...
2. Забери из него как минимум `AGENTS.md`, `AGENTS.NODES.md` и стартовый файл под свою систему, например `CLAUDE.md` или другой соответствующий файл, если твой агент работает через другую точку входа.
...
- Этот файл (`README.md`) — короткий вход для человека, а не полный протокол.
