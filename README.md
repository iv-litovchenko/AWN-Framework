# Agents nodes: когнитивная среда человека и агента

Этот проект — прототип персональной AI-экосистемы на Markdown-файлах в духе хранилища Obsidian. Главная идея: агент и человек опираются на **один канон правил** — [`AGENTS.md`](AGENTS.md) — и на **атомарные единицы знаний** — файлы `*.node.md`, перечисленные в реестре [`AGENTS.NODES.md`](AGENTS.NODES.md).

**Единственный полный справочник по правилам, полям YAML и протоколам — [`AGENTS.md`](AGENTS.md).** Этот README — вводный: что читать, в каком порядке и что делать руками.
...
```text
vault/
├── 00 🍀 Name.AI/        # ядро экосистемы: правила, роутер, память, навыки
