...
**Свои поля** (расширения под задачу или vault): любые другие ключи в той же YAML-шапке — **без** префикса `AWN-`, с **естественным** именем (`tags`, `parentNote`, `locale` и т.д.); не совпадать с каноническим списком выше и не начинаться с `AWN-` (см. `AGENTS.md`, раздел «Конвентция имён свойств в YAML»).
