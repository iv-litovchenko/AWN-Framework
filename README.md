...
Подробнее это раскрыто в [[01 Documentation/v2/AGENTS#8. Почему не жёсткие «фреймворки» и не чужие конвенции workspace|AGENTS.md -> раздел 8]], где объясняется, почему подход отличается от жёстких фреймворков и OpenClaw-подобных шаблонов.
